...
const About = () => {
  ...
  const strengths = [
    ...
    },
    {
      ...
      icon: "ri-cloud-line",
      description:
        "Building scalable applications for modern cloud environments",
    },
    {
      title: "Data Design",
  ...
  return (
    <section id="about" className="py-20 relative digital-grid" ref={ref}>
        ...
        >
          <motion.div className="w-full lg:w-1/2" variants={itemVariants}>
            <div className="bg-card p-6 rounded-lg shadow-lg glow-border">
              <h3 className="text-xl font-mono font-bold mb-4 text-secondary">
                Who Am I
              </h3>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                I'm a passionate Software Engineer with expertise in backend
                development, currently working at Philips. I specialize in
                building resilient, scalable cloud-native systems that power
                critical healthcare applications.
              </p>
              <p className="text-muted-foreground mb-4 leading-relaxed">
                With a strong foundation in .NET, AWS, and database
                technologies, I focus on creating robust architectures that
