    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-12 text-center">
          ...
          >
            Interested in working together? Let's connect! Feel free to reach out through any of the channels below.
          </motion.p>
        </div>
        ...
        >
          ...
          >
            <div className="bg-card p-6 rounded-lg shadow-lg glow-border h-full">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label htmlFor="name" className="block text-foreground mb-2 font-mono text-sm">Name</label>
                  <input 
                    type="text" 
                    id="name" 
                    value={formData.name}
                ...
                <div className="mb-4">
                  <label htmlFor="email" className="block text-foreground mb-2 font-mono text-sm">Email</label>
                  <input 
                    type="email" 
                    id="email" 
                ...
                <div className="mb-4">
                  <label htmlFor="subject" className="block text-foreground mb-2 font-mono text-sm">Subject</label>
                  <input 
                    type="text" 
                    id="subject" 
                ...
                <div className="mb-6">
                  <label htmlFor="message" className="block text-foreground mb-2 font-mono text-sm">Message</label>
                  <textarea 
                    id="message" 
                    rows={5}
          ...
          >
            <div className="bg-card p-6 rounded-lg shadow-lg glow-border h-full">
              ...
              <div className="space-y-6">
                {socialLinks.map((social, index) => (
                  <div key={index} className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-mono font-bold text-foreground">{social.title}</h4>
                      {social.link ? (
                        <a 
                          href={social.link} 
              ...
              <div className="mt-8">
                <h4 className="font-mono font-bold text-foreground mb-4">Follow Me</h4>
